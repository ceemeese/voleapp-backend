    ...
    public partial class MigracionInicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Role = table.Column<string>(type: "varchar(30)", maxLength: 30, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MembershipNumber = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourtEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CourtEvents_Courts_CourtId",
                        column: x => x.CourtId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ClubMembers_MembershipNumber",
                table: "ClubMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_CourtId_Date",
                table: "Reservations",
